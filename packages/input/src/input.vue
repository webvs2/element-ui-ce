<template>
  <div :class="[
    ...
    <template v-if="type !== 'textarea'">
      ...
      <input :tabindex="tabindex" v-if="type !== 'textarea'" class="el-input__inner" v-bind="$attrs"
    ...
    <textarea v-else :tabindex="tabindex" class="el-textarea__inner" @compositionstart="handleCompositionStart"
    ...
    <span v-if="isWordLimitVisible && type === 'textarea'" class="el-input__count">{{ textLength }}/{{ upperLimit
      }}</span>
  </div>
</template>
<script>
